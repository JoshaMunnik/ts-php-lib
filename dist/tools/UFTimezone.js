...
export class UFTimezone {
     ...
     */
    getOffset(aPhpTimezone) {
        return __awaiter(this, void 0, void 0, function* () {
            // get current system time
            const time = UFSystem.time();
            // get offset from cache (if any)
            const offset = this.m_cache.has(aPhpTimezone)
                ? this.m_cache.get(aPhpTimezone)
                : new Offset();
            ...
            try {
                const { stdout, stderr } = yield execFileAsync(this.m_php, ['-n', '-r', args]);
                if (stderr) {
     ...
     */
    getLocalFromServerDate(aServerDate, aPhpTimezone) {
        return __awaiter(this, void 0, void 0, function* () {
            // add difference from timezone (in minutes) of aDate to get utc, then add difference (in seconds) to aPhpTimezone
            return new Date(aServerDate.getTime() + 60000 * aServerDate.getTimezoneOffset() + 1000 * (yield this.getOffset(aPhpTimezone)));
        });
    }
    /**
     ...
     */
    getServerFromLocalDate(aLocalDate, aPhpTimezone) {
        return __awaiter(this, void 0, void 0, function* () {
            // subtract difference (in seconds) from aPhpTimezone to get utc, then subtract difference (in minutes) for servers
            // timezone
            return new Date(aLocalDate.getTime() - 1000 * (yield this.getOffset(aPhpTimezone)) - 60000 * aLocalDate.getTimezoneOffset());
        });
    }
    /**
     ...
     */
    getUtcFromLocalDate(aLocalDate, aPhpTimezone) {
        return __awaiter(this, void 0, void 0, function* () {
            // subtract difference (in seconds) from aPhpTimezone to get utc
            return new Date(aLocalDate.getTime() - 1000 * (yield this.getOffset(aPhpTimezone)));
        });
    }
    /**
     ...
     */
    getLocalTime(aServerDate, aPhpTimezone, anIncludeSeconds = false) {
        return __awaiter(this, void 0, void 0, function* () {
            const localDate = yield this.getLocalFromServerDate(aServerDate, aPhpTimezone);
 ...
 * @private
 */
UFTimezone.s_winterTimezones = new Map([
    ['Africa/Abidjan', 0],
    ['Africa/Accra', 0],
 ...
 * @private
 */
UFTimezone.s_summerTimezones = new Map([
    ['Africa/Abidjan', 0],
    ['Africa/Accra', 0],
    ['Africa/Addis_Ababa', 10800],
    ['Africa/Algiers', 3600],
...
// endregion
//# sourceMappingURL=UFTimezone.js.map